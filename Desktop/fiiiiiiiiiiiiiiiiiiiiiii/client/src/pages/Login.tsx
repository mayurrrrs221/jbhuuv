...
import { Sparkles, Mail, Lock, Chrome, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-2">Welcome to Finote</h1>
          <p className="text-blue-100">Your AI-powered personal finance manager</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-blue-100">
          Secure, private, and built for your financial success
        </p>
      </div>
    </div>
  );
